view: gdb_logins_daily_revenue_products {
  sql_table_name: dw_reports.gdb_logins_daily_revenue_products ;;
  ...
  dimension: lt_andr_gross_revenue {
    type: number
    sql: ${TABLE}.LT_andr_gross_revenue ;;
  }

  dimension: lt_ios_gross_revenue {
    type: number
    sql: ${TABLE}.LT_ios_gross_revenue ;;
  }
